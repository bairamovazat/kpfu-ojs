{**
 * plugins/importexport/articulus/articles.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.articulus.selectArticle"}
{assign var="pageCrumbTitle" value="plugins.importexport.articulus.selectArticle"}
