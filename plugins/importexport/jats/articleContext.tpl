{**
 * plugins/importexport/articulus/articleContext.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.articulus.import.articles"}
{include file="common/header.tpl"}
{/strip}

<p>{translate key="plugins.importexport.articulus.import.articles.description"}</p>
