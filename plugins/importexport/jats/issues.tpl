{**
 * plugins/importexport/articulus/issues.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.articulus.selectIssue"}
{assign var="pageCrumbTitle" value="plugins.importexport.articulus.selectIssue"}
