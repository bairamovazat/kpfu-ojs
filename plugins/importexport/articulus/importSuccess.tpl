{**
 * plugins/importexport/articulus/importSuccess.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.articulus.import.success"}
{include file="common/header.tpl"}
{/strip}
<div id="importSuccess">
<p>{translate key="plugins.importexport.articulus.import.success.description"}</p>
