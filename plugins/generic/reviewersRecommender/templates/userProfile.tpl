...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value"><a href="{$user->getData('orcid')|escape:"quotes"}">{$user->getData('orcid')|escape}</a></td>
	</tr>
	<tr valign="top">
		<td class="label">{translate key="plugins.generic.revrec.mathscinet"}</td>
		<td class="value"><a href="{$user->getData('mathscinet')|escape:"quotes"}">{$user->getData('mathscinet')|escape}</a></td>
	</tr>
	<tr valign="top">
		<td class="label">{translate key="plugins.generic.revrec.zbmath"}</td>
		<td class="value"><a href="{$user->getData('zbmath')|escape:"quotes"}">{$user->getData('zbmath')|escape}</a></td>
	</tr>
	<tr valign="top">
