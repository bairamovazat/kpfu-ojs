...
{/if}
	...
	<tr valign="top">
		<td class="label">{fieldLabel name="mathscinet" key="plugins.generic.revrec.mathscinet"}</td>
		<td class="value"><input type="text" name="mathscinet" id="mathscinet" value="{$mathscinet|escape}" size="30" maxlength="255" class="textField" /></td>
	</tr>
	<tr valign="top">
		<td class="label">{fieldLabel name="zbmath" key="plugins.generic.revrec.zbmath"}</td>
		<td class="value"><input type="text" name="zbmath" id="zbmath" value="{$zbmath|escape}" size="30" maxlength="255" class="textField" /></td>
	</tr>
	<tr valign="top">
